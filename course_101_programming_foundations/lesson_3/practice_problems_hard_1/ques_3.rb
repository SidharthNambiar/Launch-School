...
# Practice Problems: Hard 1 - Question 3

# In other practice problems, we have looked at how the scope of 
# variables affects the modification of one "layer" when they are passed to another.

# To drive home the salient aspects of variable scope 
# and modification of one scope by another, consider the following similar sets of code.
