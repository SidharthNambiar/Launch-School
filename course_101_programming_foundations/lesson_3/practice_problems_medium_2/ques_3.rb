...
# The operation performed on the string within the method
# doesn't modifiy the original string object, whereas, the << is a 
# destructive method, and modifies the original array object.