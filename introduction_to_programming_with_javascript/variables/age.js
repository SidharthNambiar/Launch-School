...
// Write a program named age.js that includes someone's age and then calculates and 
...
console.log(`In 20 years, you wil be ${age+30} years old.`);
console.log(`In 20 years, you wil be ${age+40} years old.`);